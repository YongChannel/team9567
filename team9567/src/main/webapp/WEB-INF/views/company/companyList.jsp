...
<%@ include file="../includes/header.jsp"%>
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                		<h2 class="page-header"> 회사 정보 등록</h2>
                    </div>
                </div>
                <!-- /.row -->
		                        ...
		                        <table class="table table-bordered table-hover table-striped">
		                        	<tbody>
										...
										<tr>  
		                                    ...
		                                    <td><input type="text" class="form-control input-sm" name="Comemployee"></td>
											
											<th class="text-center" style="width:7%">이메일</th>
		                                    <td><input type="text" class="form-control input-sm" name="Comemail"></td>
